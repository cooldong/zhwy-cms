package com.mingsoft.cms.action.custom.file;
 ...
 */
@Controller
@RequestMapping("/${managerPath}/custom/file")
public class CustomFileAction extends BaseAction {
					...
					if (fieldName.equals("uploadPath")) {
						...
						try {
							...
							if (chunk == chunks - 1) {
								...
								jsonObject.put("result", floderName+Const.SEPARATOR+ uploadPath +Const.SEPARATOR + _fileName);
